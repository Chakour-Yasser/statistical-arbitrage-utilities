# Universe decision, frozen 2026-08-19 before any backtest

> Written before the first line of backtest code and not revisable in light of results. A later
> revision would be sector-level data snooping and would have to be flagged as such.
...
Why utilities specifically. - The clearest common factor in the entire US equity market (duration + regulation) → a non-zero
...
Alternatives ruled out, and why. | Alternative | Reason for rejection |
|---|---|
